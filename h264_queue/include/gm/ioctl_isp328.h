...
typedef struct sp_param {
    ...
    bool edg_wt_enable;
#else
    unsigned char hpf_enable[6];
    unsigned char hpf_use_lpf[6];
    unsigned char nl_gain_enable;
    unsigned char edg_wt_enable;
#endif
...
#else
    unsigned char segment_mode;                  // AWB segment mode
#endif
